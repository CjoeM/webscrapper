...
for code in codes_id:
    ...
    # print(main_items.find('span', class_="item-product__valid").contents)
    ...
    if len(special_valid_date)>0:
        # print(items["special end date"].append(special_valid_date[0].split("\n")))
        date_items=special_valid_date[0].split("\n")
        ...
        try:
            ...
            # print(data["name"],"   ",main_items.find('span', class_="item-product__message__text").contents[0].split("\n ")[1])
